            ...
            <>
                <div className='content-manage-reading-exercise'>
                    <div className='content-reading-exercise-manage' style={{ paddingLeft: '10px' }}>
                        ...
                        <div className='manage-more-info-read-exercise m-3' style={{ fontSize: '25px', textAlign: 'center', fontWeight: 'bolder' }}> Quản Lý Câu Hỏi Bài Đọc</div>
                        <form>
                        ...
                        <table className="table">
                            <thead className="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col">Lá Thư Đơn</th>
                                    {/* <th scope="col">Lá Thư Đôi</th>
                                    <th scope="col">Lá Thư Ba</th> */}
