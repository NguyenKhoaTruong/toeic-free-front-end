...
import DetailStudyListenExerciseFour from './DetailStudyListenExerciseFour';
import LoginForm from '../../routes/LoginForm';
class StudyForTestPart4 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isTourOpen: false,
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(StudyForTestPart4));
